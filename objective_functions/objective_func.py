...
def objective_function(
    ...
    """
    obj = (
        hourly_energy * formatted_demand_df["Hourly Demand Met (in MW)"]
        - field_htf_pump_power * formatted_demand_df["Hourly Demand Met (in MW)"]
        - pc_htf_pump_power * formatted_demand_df["Hourly Demand Met (in MW)"]
    )
